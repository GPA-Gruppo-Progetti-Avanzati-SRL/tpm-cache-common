...
func TestIncrementOverflowInt(t *testing.T) {
	...
	vint8 := x.(int8)
	if vint8 != -128 {
		t.Error("int8 did not overflow as expected; value:", vint8)
	}
...
func TestIncrementOverflowUint(t *testing.T) {
	...
	vuint8 := x.(uint8)
	if vuint8 != 0 {
		t.Error("uint8 did not overflow as expected; value:", vuint8)
	}
}
...
func TestDecrementUnderflowUint(t *testing.T) {
	...
	vuint8 := x.(uint8)
	if vuint8 != 255 {
		t.Error("uint8 did not underflow as expected; value:", vuint8)
	}
}
...
func TestCacheSerialization(t *testing.T) {
	...
	// testFillAndSerialize Check if gob.Register behaves properly even after multiple gob.Register
